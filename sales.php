<?php
  ...
  // Fetch all sales with customer information
  $sales = find_all_sales_with_customers();
  
  // Debugging line to print fetched sales data
  error_log('Sales: ' . print_r($sales, true)); // Debugging line
?>
